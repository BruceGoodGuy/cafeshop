                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <img src="{{ asset('back/assets/images/users/avatar-1.jpg') }}"
                                                alt="contact-img" title="contact-img" class="rounded-circle avatar-sm" />
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <img src="{{ asset('back/assets/images/users/avatar-5.jpg') }}"
                                                alt="contact-img" title="contact-img" class="rounded-circle avatar-sm" />
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <img src="{{ asset('back/assets/images/users/avatar-6.jpg') }}"
                                                alt="contact-img" title="contact-img" class="rounded-circle avatar-sm" />
                                        </td>
